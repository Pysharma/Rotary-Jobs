...
class popularLcJob extends StatefulWidget {
  const popularLcJob({Key? key}) : super(key: key);

  @override
  State<popularLcJob> createState() => _popularLcJobState();
}

class _popularLcJobState extends State<popularLcJob> {
  @override
                            ...
                            child: Row(
                              ...
                              children: [
                                TextButton(
                                  ...
                                  child: Text('View Details',style: TextStyle(fontFamily: 'Poppins',fontSize: 15,color: Colors.black87,),),
                                ),
